// Animated Connection Line for RBAC Authorization Flow
...
export function ConnectionLine({ 
  ...
  const packetColor = requestColors[requestType] || color;
  ...
  return (
    ...
    >
      ...
      <line
        ...
        strokeDasharray={requestType === 'denied' && isActive ? '5,5' : 'none'}
