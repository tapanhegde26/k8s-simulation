// Geometric Shape Components for Service Mesh mTLS Flow Animation
  ...
  return (
    ...
    >
      <svg width={width} height={height} style={{ filter: glowFilter(color, !!isActive) }}>
        ...
        <rect x={width*0.82} y={height*0.52} width={3} height={height*0.15} fill={isActive ? color : `${color}cc`} />
      </svg>
    </motion.div>
  );
}
      ...
      <svg width={width} height={height} style={{ filter: glowFilter(color, !!isActive) }}>
        <path
          d={`M${width*0.2},${height*0.4} 
              ...
              Q${width*0.2},${height*0.1} ${width/2},${height*0.1}
              Q${width*0.8},${height*0.1} ${width*0.8},${height*0.3}
        ...
        />
        <circle
          cx={width/2} cy={height*0.6}
          r={height*0.06}
          fill="#1e293b"
        />
        <rect
          x={width/2 - 2} y={height*0.62}
          width={4} height={height*0.12}
          fill="#1e293b"
        />
      </svg>
    </motion.div>
